...
void fake_fooRvoidPvoid_0(int count, ...) {
    ::ftest::called.insert(reinterpret_cast<char *>(fake_fooRvoidPvoid_0));
    EXPECT_EQ(count, 0);
    fake_fooRvoidPvoid();
}
// User provides
...
TEST_F(FooFixture, fooRvoidPvoid) {
    ...
    EXPECT_EQ(::ftest::called.count(address(fake_fooRvoidPvoid_0)), 1);
...
void fake_fooRvoidPint_0(int count, ...) {
    ::ftest::called.insert(reinterpret_cast<char *>(fake_fooRvoidPint_0));
...
TEST_F(FooFixture, fooRvoidPint) {
    ...
    EXPECT_EQ(::ftest::called.count(address(fake_fooRvoidPint_0)), 1);
